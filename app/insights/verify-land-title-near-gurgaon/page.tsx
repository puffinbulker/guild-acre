    ...
    <main className="min-h-screen bg-slate-950 text-white">
      <section className="mx-auto max-w-4xl px-4 py-16 sm:px-6 lg:px-8 lg:py-20">
        ...
        <div className="mt-10 space-y-8 text-slate-300">
          <section>
            <h2 className="text-2xl font-semibold text-white">1. Confirm who legally owns the land</h2>
          ...
          <section>
            <h2 className="text-2xl font-semibold text-white">2. Understand the exact land use story</h2>
            <p className="mt-3 leading-8">
          ...
          <section>
            <h2 className="text-2xl font-semibold text-white">3. Ask the uncomfortable questions early</h2>
            <p className="mt-3 leading-8">
          ...
          <section>
            <h2 className="text-2xl font-semibold text-white">4. Match the title story to your real objective</h2>
            <p className="mt-3 leading-8">
          ...
          <section>
            <h2 className="text-2xl font-semibold text-white">5. Use legal review before emotional commitment</h2>
            <p className="mt-3 leading-8">
