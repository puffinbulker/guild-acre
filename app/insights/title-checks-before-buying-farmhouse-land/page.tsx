    ...
    <main className="min-h-screen bg-slate-950 text-white">
      <section className="mx-auto max-w-4xl px-4 py-16 sm:px-6 lg:px-8 lg:py-20">
        ...
        <div className="mt-10 space-y-8 text-slate-300">
          <section>
            <h2 className="text-2xl font-semibold text-white">Start with ownership clarity, not ambiance</h2>
          ...
          <section>
            <h2 className="text-2xl font-semibold text-white">Match the document story to the actual selling story</h2>
            <p className="mt-3 leading-8">
          ...
          <section>
            <h2 className="text-2xl font-semibold text-white">Ask what would make you uncomfortable later</h2>
            <p className="mt-3 leading-8">
          ...
          <section>
            <h2 className="text-2xl font-semibold text-white">Use legal review before the deal feels emotionally “done”</h2>
            <p className="mt-3 leading-8">
