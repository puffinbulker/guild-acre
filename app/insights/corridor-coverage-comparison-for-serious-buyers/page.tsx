    ...
    <main className="min-h-screen bg-[#050505] text-[#f4ead8]">
      <section className="mx-auto max-w-4xl px-4 py-16 sm:px-6 lg:px-8 lg:py-20">
        ...
        <div className="mt-10 space-y-8 text-[#cfc5b3]">
          <section>
            <h2 className="text-2xl font-semibold text-[#f4ead8]">Golf Course Road tends to anchor the luxury conversation</h2>
          ...
          <section>
            <h2 className="text-2xl font-semibold text-[#f4ead8]">Golf Course Extension Road often suits premium upgrade buyers</h2>
            <p className="mt-3 leading-8">
          ...
          <section>
            <h2 className="text-2xl font-semibold text-[#f4ead8]">Dwarka Expressway is usually read through growth and momentum</h2>
            <p className="mt-3 leading-8">
          ...
          <section>
            <h2 className="text-2xl font-semibold text-[#f4ead8]">Sohna Road and adjoining belts need more use-case clarity</h2>
            <p className="mt-3 leading-8">
